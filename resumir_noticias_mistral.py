...
def resumir_con_ollama(texto, modelo="mistral"):
...
def guardar_noticias_con_resumen(archivo_entrada="noticias_portafolio.csv", archivo_salida="noticias_portafolio_resumen_Mistral.csv", modelo="mistral"):
    try:
...
if __name__ == "__main__":
    guardar_noticias_con_resumen(modelo="mistral")  # o "gemma"